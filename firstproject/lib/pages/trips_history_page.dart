...
class _TripsHistoryPageState extends State<TripsHistoryPage> {
  ...
  final completedTripsTripRequestOfCurrentDriver = FirebaseDatabase.instance.ref().child("tripRequests");
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: completedTripsTripRequestOfCurrentDriver.onValue,
